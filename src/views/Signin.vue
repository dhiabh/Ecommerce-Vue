        ...
        <div id="signin-div" class="flex-item border">
          ...
          <form @submit="signin" class="pt-4 pl-4 pr-4">
            ...
            <small class="form-text text-muted"
              >By continuing, you agree to e-commerce's Conditions of Use and
          ...
          <small class="form-text text-muted pt-2 pl-4 text-center"
            >New to e-commerce?</small
          >
          <p class="text-center">
            <router-link
              :to="{ name: 'Signup' }"
              class="btn btn-dark text-center mx-auto px-5 py-1 mb-2"
              >Create Your e-commerce Account</router-link
            >
          </p>
        </div>
      </div>
    ...
    async signin(e) {
      ...
      await axios
        ...
        .then((res) => {
          ...
          swal({
            text: "You Logged in successfully. Welcome Back!",
            icon: "success",
